...
export default function ReferralListScreen() {
  ...
  const referredUsers = [
    { id: 1, name: 'John Doe', username: '@johndoe', status: 'Completed', reward: '₹50' },
    { id: 2, name: 'Alice Smith', username: '@alice', status: 'Pending', reward: '₹20' },
    { id: 3, name: 'Bob Johnson', username: '@bob_j', status: 'Completed', reward: '₹50' },
  ];
    ...
    <View className="flex-1 bg-[#12081E] pt-14">
      ...
      >
        <View className="flex-row justify-between items-center mb-2">
          <Text className="text-neutral-grey text-[10px] font-bold uppercase tracking-widest">Referred Friends (24)</Text>
          <Text className="text-[#A855F7] font-bold text-xs">Total Earned: ₹1,450</Text>
        </View>
        ...
        <View className="items-center py-12 opacity-50 mt-8">
          ...
          <Text className="text-neutral-grey text-xs text-center px-8 mt-4">
